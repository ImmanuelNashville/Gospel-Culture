    ...
    <>
      ...
      <Modal open={showModal} onClose={handleModalClose}>
        <div className="m-6 min-w-min space-y-2 text-left">
          <h1 className="text-2xl font-bold dark:text-gray-200">The Bright Trip Newsletter</h1>
          <p className="pb-4 text-bodySmall font-bodycopy max-w-md dark:text-gray-300">
            Get the latest updates from the Bright Team team delivered straight to your email inbox. No spam,
            unsubscribe anytime.
          </p>
